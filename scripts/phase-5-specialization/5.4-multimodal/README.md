...
```bash
# Vision API basics
python "scripts/phase-5-specialization/5.4-multimodal/01_vision_basics.py"
# CLIP embeddings
python "scripts/phase-5-specialization/5.4-multimodal/02_clip_basics.py"
# Build image search
python "scripts/phase-5-specialization/5.4-multimodal/03_image_text_search.py"
# Document extraction
python "scripts/phase-5-specialization/5.4-multimodal/04_document_vision.py"
```
