...
python "scripts/phase-5-specialization/5.1-fine-tuning/01_when_to_finetune.py"
# Data preparation best practices
python "scripts/phase-5-specialization/5.1-fine-tuning/02_data_preparation.py"
# LoRA and QLoRA concepts
python "scripts/phase-5-specialization/5.1-fine-tuning/03_lora_basics.py"
# Quantization for efficient inference
python "scripts/phase-5-specialization/5.1-fine-tuning/04_quantization.py"
# Alignment techniques (SFT/RLHF/DPO)
python "scripts/phase-5-specialization/5.1-fine-tuning/05_sft_rlhf_dpo_overview.py"
# Evaluation methods
python "scripts/phase-5-specialization/5.1-fine-tuning/06_evaluation.py"
```
