...
```bash
# Dependency parsing
python "scripts/phase-5-specialization/5.3-advanced-nlp/01_dependency_parsing.py"
# Relation extraction
python "scripts/phase-5-specialization/5.3-advanced-nlp/02_relation_extraction.py"
# Coreference resolution
python "scripts/phase-5-specialization/5.3-advanced-nlp/03_coreference.py"
```
