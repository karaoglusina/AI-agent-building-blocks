...
```bash
# Input validation
python "scripts/phase-4-production/4.4-guardrails/01_input_validation.py"
# Prompt injection detection
python "scripts/phase-4-production/4.4-guardrails/02_prompt_injection.py"
# Jailbreak defense
python "scripts/phase-4-production/4.4-guardrails/03_jailbreak_defense.py"
# PII filtering
python "scripts/phase-4-production/4.4-guardrails/04_pii_filtering.py"
# Output validation
python "scripts/phase-4-production/4.4-guardrails/05_output_validation.py"
# Content moderation
python "scripts/phase-4-production/4.4-guardrails/06_content_moderation.py"
# Guardrail architecture
python "scripts/phase-4-production/4.4-guardrails/07_guardrail_architecture.py"
# Model gateway
python "scripts/phase-4-production/4.4-guardrails/08_model_gateway.py"
```
