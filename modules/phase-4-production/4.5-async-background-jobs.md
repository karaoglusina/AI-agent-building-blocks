...
|--------|---------------|
| <a href="../../scripts/phase-4-production/4.5-async-background-jobs/01_asyncio_basics.py">01_asyncio_basics.py</a> | Async/await fundamentals |
| <a href="../../scripts/phase-4-production/4.5-async-background-jobs/02_concurrent_llm.py">02_concurrent_llm.py</a> | Parallel LLM calls |
| <a href="../../scripts/phase-4-production/4.5-async-background-jobs/03_celery_setup.py">03_celery_setup.py</a> | Configure Celery with Redis |
| <a href="../../scripts/phase-4-production/4.5-async-background-jobs/04_background_task.py">04_background_task.py</a> | Long-running tasks |
| <a href="../../scripts/phase-4-production/4.5-async-background-jobs/05_task_status.py">05_task_status.py</a> | Monitor job progress |
