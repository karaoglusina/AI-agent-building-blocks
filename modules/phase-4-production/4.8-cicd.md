...
| File | What it shows |
|------|---------------|
| <a href="../../scripts/phase-4-production/4.8-cicd/01_github_actions.yml">01_github_actions.yml</a> | Basic CI workflow |
| <a href="../../scripts/phase-4-production/4.8-cicd/02_automated_tests.yml">02_automated_tests.yml</a> | Run tests with services |
| <a href="../../scripts/phase-4-production/4.8-cicd/03_deploy_workflow.yml">03_deploy_workflow.yml</a> | Deploy on merge to main |
