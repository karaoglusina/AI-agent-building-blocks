...
|--------|---------------|
| <a href="../../scripts/phase-4-production/4.2-postgresql-pgvector/01_sqlalchemy_basics.py">01_sqlalchemy_basics.py</a> | Define models, create tables |
| <a href="../../scripts/phase-4-production/4.2-postgresql-pgvector/02_crud_operations.py">02_crud_operations.py</a> | Create, read, update, delete |
| <a href="../../scripts/phase-4-production/4.2-postgresql-pgvector/03_alembic_migrations.py">03_alembic_migrations.py</a> | Database schema versioning |
| <a href="../../scripts/phase-4-production/4.2-postgresql-pgvector/04_pgvector_setup.py">04_pgvector_setup.py</a> | Enable vector extension |
| <a href="../../scripts/phase-4-production/4.2-postgresql-pgvector/05_vector_search_pg.py">05_vector_search_pg.py</a> | Semantic search |
| <a href="../../scripts/phase-4-production/4.2-postgresql-pgvector/06_hybrid_pg.py">06_hybrid_pg.py</a> | Full-text + vector search |
