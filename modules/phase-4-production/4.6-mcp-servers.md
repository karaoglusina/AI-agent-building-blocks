...
|--------|---------------|
| <a href="../../scripts/phase-4-production/4.6-mcp-servers/01_mcp_overview.py">01_mcp_overview.py</a> | What MCP is and why |
| <a href="../../scripts/phase-4-production/4.6-mcp-servers/02_mcp_client.py">02_mcp_client.py</a> | Connect to MCP servers |
| <a href="../../scripts/phase-4-production/4.6-mcp-servers/03_mcp_tool_use.py">03_mcp_tool_use.py</a> | Call tools via MCP |
| <a href="../../scripts/phase-4-production/4.6-mcp-servers/04_custom_mcp_server.py">04_custom_mcp_server.py</a> | Build your own server |
