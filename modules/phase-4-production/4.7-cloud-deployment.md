...
| File | What it shows |
|------|---------------|
| <a href="../../scripts/phase-4-production/4.7-cloud-deployment/01_vm_setup.md">01_vm_setup.md</a> | Setting up a cloud VM |
| <a href="../../scripts/phase-4-production/4.7-cloud-deployment/02_https_caddy.md">02_https_caddy.md</a> | HTTPS with Caddy |
| <a href="../../scripts/phase-4-production/4.7-cloud-deployment/03_health_checks.py">03_health_checks.py</a> | Health and readiness endpoints |
| <a href="../../scripts/phase-4-production/4.7-cloud-deployment/04_logging_config.py">04_logging_config.py</a> | Production logging |
