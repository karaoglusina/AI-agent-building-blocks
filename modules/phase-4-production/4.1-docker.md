...
|--------|---------------|
| <a href="../../scripts/phase-4-production/4.1-docker/01_dockerfile_basics.py">01_dockerfile_basics.py</a> | Creating Dockerfiles |
| <a href="../../scripts/phase-4-production/4.1-docker/02_docker_compose.py">02_docker_compose.py</a> | Multi-container orchestration |
| <a href="../../scripts/phase-4-production/4.1-docker/03_environment_config.py">03_environment_config.py</a> | Managing configuration |
| <a href="../../scripts/phase-4-production/4.1-docker/Dockerfile">Dockerfile</a> | Production-ready example |
| <a href="../../scripts/phase-4-production/4.1-docker/docker-compose.yml">docker-compose.yml</a> | Full stack setup |
