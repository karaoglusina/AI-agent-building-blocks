...
|--------|---------------|
| <a href="../../scripts/phase-4-production/4.3-observability/01_langfuse_setup.py">01_langfuse_setup.py</a> | Initialize and verify connection |
| <a href="../../scripts/phase-4-production/4.3-observability/02_trace_llm_calls.py">02_trace_llm_calls.py</a> | Log LLM interactions |
| <a href="../../scripts/phase-4-production/4.3-observability/03_trace_rag_pipeline.py">03_trace_rag_pipeline.py</a> | End-to-end RAG tracing |
| <a href="../../scripts/phase-4-production/4.3-observability/04_cost_monitoring.py">04_cost_monitoring.py</a> | Track token usage and costs |
| <a href="../../scripts/phase-4-production/4.3-observability/05_custom_metrics.py">05_custom_metrics.py</a> | Add business metrics |
