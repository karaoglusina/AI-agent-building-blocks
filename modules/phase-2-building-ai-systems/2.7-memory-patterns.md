...
|--------|---------------|
| <a href="../../scripts/phase-2-building-ai-systems/2.7-memory-patterns/01_conversation_buffer.py">01_conversation_buffer.py</a> | Simple full-history storage |
| <a href="../../scripts/phase-2-building-ai-systems/2.7-memory-patterns/02_sliding_window.py">02_sliding_window.py</a> | Bounded recent history |
| <a href="../../scripts/phase-2-building-ai-systems/2.7-memory-patterns/03_summary_memory.py">03_summary_memory.py</a> | Compress old messages |
| <a href="../../scripts/phase-2-building-ai-systems/2.7-memory-patterns/04_entity_memory.py">04_entity_memory.py</a> | Track entities in conversation |
| <a href="../../scripts/phase-2-building-ai-systems/2.7-memory-patterns/05_long_term_storage.py">05_long_term_storage.py</a> | Persist across sessions |
| <a href="../../scripts/phase-2-building-ai-systems/2.7-memory-patterns/06_memory_retrieval.py">06_memory_retrieval.py</a> | Semantic memory retrieval |
