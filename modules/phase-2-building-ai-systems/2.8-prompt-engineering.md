...
|--------|---------------|
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/01_system_prompt_design.py">01_system_prompt_design.py</a> | Structuring effective system prompts |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/02_chain_of_thought.py">02_chain_of_thought.py</a> | Step-by-step reasoning |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/03_few_shot_examples.py">03_few_shot_examples.py</a> | Learning from examples |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/04_output_formatting.py">04_output_formatting.py</a> | Controlling output structure |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/05_instructor_basics.py">05_instructor_basics.py</a> | Model-agnostic structured output |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/06_constrained_generation.py">06_constrained_generation.py</a> | Forcing specific formats |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/07_defensive_prompting.py">07_defensive_prompting.py</a> | Protecting against misuse |
| <a href="../../scripts/phase-2-building-ai-systems/2.8-prompt-engineering/08_self_consistency.py">08_self_consistency.py</a> | Multiple samples for reliability |
