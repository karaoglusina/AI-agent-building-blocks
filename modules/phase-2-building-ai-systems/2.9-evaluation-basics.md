...
|--------|---------------|
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/01_classification_metrics.py">01_classification_metrics.py</a> | Precision, recall, F1, confusion matrix |
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/02_retrieval_metrics.py">02_retrieval_metrics.py</a> | MRR, precision@k, recall@k |
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/03_generation_metrics.py">03_generation_metrics.py</a> | BLEU, ROUGE |
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/04_llm_as_judge.py">04_llm_as_judge.py</a> | Using LLM for evaluation |
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/05_simple_eval_loop.py">05_simple_eval_loop.py</a> | Systematic evaluation pipeline |
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/06_comparison_eval.py">06_comparison_eval.py</a> | A/B comparison |
| <a href="../../scripts/phase-2-building-ai-systems/2.9-evaluation-basics/07_embedding_evaluation.py">07_embedding_evaluation.py</a> | Testing embeddings on your domain |
