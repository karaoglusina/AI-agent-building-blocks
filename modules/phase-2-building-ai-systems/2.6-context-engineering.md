...
|--------|---------------|
| <a href="../../scripts/phase-2-building-ai-systems/2.6-context-engineering/01_context_window_basics.py">01_context_window_basics.py</a> | Understanding token limits |
| <a href="../../scripts/phase-2-building-ai-systems/2.6-context-engineering/02_prompt_assembly.py">02_prompt_assembly.py</a> | Building prompts from components |
| <a href="../../scripts/phase-2-building-ai-systems/2.6-context-engineering/03_context_prioritization.py">03_context_prioritization.py</a> | Selecting what to include |
| <a href="../../scripts/phase-2-building-ai-systems/2.6-context-engineering/04_context_compression.py">04_context_compression.py</a> | Fitting more in less space |
| <a href="../../scripts/phase-2-building-ai-systems/2.6-context-engineering/05_dynamic_system_prompts.py">05_dynamic_system_prompts.py</a> | Adapting system prompts |
