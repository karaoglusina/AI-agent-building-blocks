...
python modules/phase5/5.2-custom-embeddings/01_sentence_transformers.py

# Domain adaptation with TSDAE
python modules/phase5/5.2-custom-embeddings/02_domain_adaptation_tsdae.py

# Evaluating embedding quality
python modules/phase5/5.2-custom-embeddings/03_embedding_evaluation.py

# Understanding and measuring bias
python modules/phase5/5.2-custom-embeddings/04_bias_in_embeddings.py
```
