...
|--------|---------------|
| <a href="../../scripts/phase-1-foundations/1.6-vector-search/01_chroma_basics.py">01_chroma_basics.py</a> | Basic add and query operations |
| <a href="../../scripts/phase-1-foundations/1.6-vector-search/02_persistent_storage.py">02_persistent_storage.py</a> | Save collections to disk |
| <a href="../../scripts/phase-1-foundations/1.6-vector-search/03_metadata_filtering.py">03_metadata_filtering.py</a> | Filter results by metadata |
| <a href="../../scripts/phase-1-foundations/1.6-vector-search/04_openai_embeddings.py">04_openai_embeddings.py</a> | Use OpenAI embeddings with ChromaDB |
| <a href="../../scripts/phase-1-foundations/1.6-vector-search/05_job_database.py">05_job_database.py</a> | Build a searchable job database |
| <a href="../../scripts/phase-1-foundations/1.6-vector-search/06_crud_operations.py">06_crud_operations.py</a> | Create, Read, Update, Delete operations |
