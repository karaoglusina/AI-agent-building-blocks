...
|--------|---------------|
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/01_basic_model.py">01_basic_model.py</a> | Define models with type hints |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/02_field_types.py">02_field_types.py</a> | Common types: str, int, list, dict, datetime |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/03_validation.py">03_validation.py</a> | Field constraints and custom validators |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/04_nested_models.py">04_nested_models.py</a> | Models containing other models |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/05_json_serialization.py">05_json_serialization.py</a> | Convert to/from JSON and dicts |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/06_from_raw_data.py">06_from_raw_data.py</a> | Parse the job data into models |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/07_model_methods.py">07_model_methods.py</a> | Add computed fields and methods |
| <a href="../../scripts/phase-1-foundations/1.2-pydantic-basics/08_enums_literals.py">08_enums_literals.py</a> | Restrict values to specific options |
