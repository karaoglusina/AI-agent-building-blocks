...
|--------|---------------|
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/01_basic_embedding.py">01_basic_embedding.py</a> | Create a single embedding |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/02_embedding_models.py">02_embedding_models.py</a> | Compare different embedding models |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/03_batch_embeddings.py">03_batch_embeddings.py</a> | Embed multiple texts efficiently |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/04_cosine_similarity.py">04_cosine_similarity.py</a> | Measure vector similarity |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/05_simple_search.py">05_simple_search.py</a> | Basic vector search implementation |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/06_job_search.py">06_job_search.py</a> | Search the job data by meaning |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/07_save_load_embeddings.py">07_save_load_embeddings.py</a> | Persist embeddings to disk |
| <a href="../../scripts/phase-1-foundations/1.5-embeddings/08_numpy_operations.py">08_numpy_operations.py</a> | Essential numpy for vector operations |
