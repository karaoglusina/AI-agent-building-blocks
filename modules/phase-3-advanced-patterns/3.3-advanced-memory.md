...
|--------|---------------|
| <a href="../../scripts/phase-3-advanced-patterns/3.3-advanced-memory/01_structured_memory.py">01_structured_memory.py</a> | Enforcing schemas on memories |
| <a href="../../scripts/phase-3-advanced-patterns/3.3-advanced-memory/02_memory_importance.py">02_memory_importance.py</a> | Scoring what to keep |
| <a href="../../scripts/phase-3-advanced-patterns/3.3-advanced-memory/03_memory_consolidation.py">03_memory_consolidation.py</a> | Merging redundant info |
| <a href="../../scripts/phase-3-advanced-patterns/3.3-advanced-memory/04_preference_memory.py">04_preference_memory.py</a> | Detecting and storing preferences |
| <a href="../../scripts/phase-3-advanced-patterns/3.3-advanced-memory/05_episodic_memory.py">05_episodic_memory.py</a> | Recalling specific interactions |
