...
|--------|---------------|
| <a href="../../scripts/phase-3-advanced-patterns/3.6-fastapi-basics/01_hello_fastapi.py">01_hello_fastapi.py</a> | Minimal API setup |
| <a href="../../scripts/phase-3-advanced-patterns/3.6-fastapi-basics/02_pydantic_validation.py">02_pydantic_validation.py</a> | Request/response validation |
| <a href="../../scripts/phase-3-advanced-patterns/3.6-fastapi-basics/03_async_endpoints.py">03_async_endpoints.py</a> | Non-blocking endpoints |
| <a href="../../scripts/phase-3-advanced-patterns/3.6-fastapi-basics/04_streaming_response.py">04_streaming_response.py</a> | Stream LLM output |
| <a href="../../scripts/phase-3-advanced-patterns/3.6-fastapi-basics/05_chat_endpoint.py">05_chat_endpoint.py</a> | Stateful conversation |
| <a href="../../scripts/phase-3-advanced-patterns/3.6-fastapi-basics/06_rag_endpoint.py">06_rag_endpoint.py</a> | Full RAG pipeline |
