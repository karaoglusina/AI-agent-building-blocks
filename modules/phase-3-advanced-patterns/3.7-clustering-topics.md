...
|--------|---------------|
| <a href="../../scripts/phase-3-advanced-patterns/3.7-clustering-topics/01_kmeans_clustering.py">01_kmeans_clustering.py</a> | Basic document clustering |
| <a href="../../scripts/phase-3-advanced-patterns/3.7-clustering-topics/02_umap_visualization.py">02_umap_visualization.py</a> | Visualize embeddings in 2D |
| <a href="../../scripts/phase-3-advanced-patterns/3.7-clustering-topics/03_bertopic_basics.py">03_bertopic_basics.py</a> | Automatic topic discovery |
| <a href="../../scripts/phase-3-advanced-patterns/3.7-clustering-topics/04_cluster_labeling.py">04_cluster_labeling.py</a> | Generate readable labels |
| <a href="../../scripts/phase-3-advanced-patterns/3.7-clustering-topics/05_topic_coherence.py">05_topic_coherence.py</a> | Evaluate topic quality |
| <a href="../../scripts/phase-3-advanced-patterns/3.7-clustering-topics/06_interactive_exploration.py">06_interactive_exploration.py</a> | Programmatic cluster exploration |
