...
|--------|---------------|
| <a href="../../scripts/phase-3-advanced-patterns/3.9-document-processing/01_pdf_pymupdf.py">01_pdf_pymupdf.py</a> | Fast, accurate extraction |
| <a href="../../scripts/phase-3-advanced-patterns/3.9-document-processing/02_pdf_pypdf.py">02_pdf_pypdf.py</a> | Pure Python extraction |
| <a href="../../scripts/phase-3-advanced-patterns/3.9-document-processing/03_pdf_with_structure.py">03_pdf_with_structure.py</a> | Preserve headings and hierarchy |
| <a href="../../scripts/phase-3-advanced-patterns/3.9-document-processing/04_pdf_to_chunks.py">04_pdf_to_chunks.py</a> | Full pipeline to indexed chunks |
