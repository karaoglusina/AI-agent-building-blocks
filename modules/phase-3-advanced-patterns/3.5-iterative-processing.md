...
|--------|---------------|
| <a href="../../scripts/phase-3-advanced-patterns/3.5-iterative-processing/01_map_reduce.py">01_map_reduce.py</a> | Divide, process, combine |
| <a href="../../scripts/phase-3-advanced-patterns/3.5-iterative-processing/02_progressive_summary.py">02_progressive_summary.py</a> | Multi-stage summarization |
| <a href="../../scripts/phase-3-advanced-patterns/3.5-iterative-processing/03_refinement_chain.py">03_refinement_chain.py</a> | Iterative improvement |
| <a href="../../scripts/phase-3-advanced-patterns/3.5-iterative-processing/04_hierarchical_processing.py">04_hierarchical_processing.py</a> | Detail to abstraction |
| <a href="../../scripts/phase-3-advanced-patterns/3.5-iterative-processing/05_batch_processing.py">05_batch_processing.py</a> | High-throughput processing |
...
- [Context Engineering](../phase-2-building-ai-systems/2.6-context-engineering.md) - Managing what fits in context
- [Document Processing](./3.9-document-processing.md) - Preparing documents for processing
- [Evaluation Systems](./3.8-evaluation-systems.md) - Measuring processing quality
