...
|--------|---------------|
| <a href="../../scripts/phase-3-advanced-patterns/3.8-evaluation-systems/01_eval_dataset.py">01_eval_dataset.py</a> | Creating test data |
| <a href="../../scripts/phase-3-advanced-patterns/3.8-evaluation-systems/02_eval_pipeline.py">02_eval_pipeline.py</a> | Automated evaluation |
| <a href="../../scripts/phase-3-advanced-patterns/3.8-evaluation-systems/03_regression_testing.py">03_regression_testing.py</a> | Compare to baseline |
| <a href="../../scripts/phase-3-advanced-patterns/3.8-evaluation-systems/04_prompt_versioning.py">04_prompt_versioning.py</a> | Track and compare prompts |
| <a href="../../scripts/phase-3-advanced-patterns/3.8-evaluation-systems/05_cost_tracking.py">05_cost_tracking.py</a> | Monitor API costs |
| <a href="../../scripts/phase-3-advanced-patterns/3.8-evaluation-systems/06_human_eval_design.py">06_human_eval_design.py</a> | Structure human evaluation |
