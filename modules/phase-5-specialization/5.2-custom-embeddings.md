...
|--------|---------------|
| <a href="../../scripts/phase-5-specialization/5.2-custom-embeddings/01_sentence_transformers.py">01_sentence_transformers.py</a> | Local embeddings with Sentence Transformers |
| <a href="../../scripts/phase-5-specialization/5.2-custom-embeddings/02_domain_adaptation_tsdae.py">02_domain_adaptation_tsdae.py</a> | Unsupervised adaptation for your domain |
| <a href="../../scripts/phase-5-specialization/5.2-custom-embeddings/03_embedding_evaluation.py">03_embedding_evaluation.py</a> | Measure embedding quality rigorously |
| <a href="../../scripts/phase-5-specialization/5.2-custom-embeddings/04_bias_in_embeddings.py">04_bias_in_embeddings.py</a> | Detect and mitigate embedding biases |
