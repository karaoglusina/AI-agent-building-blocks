...
|--------|---------------|
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/01_mcp_overview.py">01_mcp_overview.py</a> | What MCP is and why |
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/02_mcp_client.py">02_mcp_client.py</a> | Connect to MCP servers |
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/03_mcp_tool_use.py">03_mcp_tool_use.py</a> | Call tools via MCP |
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/04_custom_mcp_server.py">04_custom_mcp_server.py</a> | Build your own server |
...
- <a href="../phase-2-building-ai-systems/2.5-agent-orchestration.md">Agent Orchestration</a> - Tools in agents
- <a href="../phase-3-advanced-patterns/3.6-fastapi-basics.md">FastAPI Basics</a> - Alternative: HTTP APIs
