...
|--------|---------------|
| [01_mcp_overview.py](../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/01_mcp_overview.py) | What MCP is and why |
| [02_mcp_client.py](../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/02_mcp_client.py) | Connect to MCP servers |
| [03_mcp_tool_use.py](../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/03_mcp_tool_use.py) | Call tools via MCP |
| [04_custom_mcp_server.py](../../modules/Phase%204%20-%20Production%20Systems/4.6-mcp-servers/04_custom_mcp_server.py) | Build your own server |
