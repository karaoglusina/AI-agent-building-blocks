...
|--------|---------------|
| [01_langfuse_setup.py](../../modules/Phase 4 - Production Systems/4.3-observability/01_langfuse_setup.py) | Initialize and verify connection |
| [02_trace_llm_calls.py](../../modules/Phase 4 - Production Systems/4.3-observability/02_trace_llm_calls.py) | Log LLM interactions |
| [03_trace_rag_pipeline.py](../../modules/Phase 4 - Production Systems/4.3-observability/03_trace_rag_pipeline.py) | End-to-end RAG tracing |
| [04_cost_monitoring.py](../../modules/Phase 4 - Production Systems/4.3-observability/04_cost_monitoring.py) | Track token usage and costs |
| [05_custom_metrics.py](../../modules/Phase 4 - Production Systems/4.3-observability/05_custom_metrics.py) | Add business metrics |
