...
|--------|---------------|
| [01_langfuse_setup.py](../../modules/Phase%204%20-%20Production%20Systems/4.3-observability/01_langfuse_setup.py) | Initialize and verify connection |
| [02_trace_llm_calls.py](../../modules/Phase%204%20-%20Production%20Systems/4.3-observability/02_trace_llm_calls.py) | Log LLM interactions |
| [03_trace_rag_pipeline.py](../../modules/Phase%204%20-%20Production%20Systems/4.3-observability/03_trace_rag_pipeline.py) | End-to-end RAG tracing |
| [04_cost_monitoring.py](../../modules/Phase%204%20-%20Production%20Systems/4.3-observability/04_cost_monitoring.py) | Track token usage and costs |
| [05_custom_metrics.py](../../modules/Phase%204%20-%20Production%20Systems/4.3-observability/05_custom_metrics.py) | Add business metrics |
...
- [Evaluation Systems](../phase-3-advanced-patterns/3.8-evaluation-systems.md) - Using traces for evaluation
- [Guardrails](./4.4-guardrails.md) - Monitor guardrail effectiveness
- [CI/CD](./4.8-cicd.md) - Automated quality checks
