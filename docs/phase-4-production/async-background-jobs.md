...
| 02_concurrent_llm.py | Parallel LLM calls |
| 03_celery_setup.py | Configure Celery with Redis |
| 04_background_task.py | Long-running tasks |
| 05_task_status.py | Monitor job progress |
...
- [FastAPI Basics](../phase-3-advanced-patterns/fastapi-basics.md) - API for triggering jobs
- [Docker](./docker.md) - Containerizing workers
- [Iterative Processing](../phase-3-advanced-patterns/iterative-processing.md) - Processing large content
