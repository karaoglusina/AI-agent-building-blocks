...
|--------|---------------|
| 01_mcp_overview.py | What MCP is and why |
| 02_mcp_client.py | Connect to MCP servers |
| 03_mcp_tool_use.py | Call tools via MCP |
| 04_custom_mcp_server.py | Build your own server |
...
- [Agent Orchestration](../phase-2-building-ai-systems/agent-orchestration.md) - Tools in agents
- [FastAPI Basics](../phase-3-advanced-patterns/fastapi-basics.md) - Alternative: HTTP APIs
