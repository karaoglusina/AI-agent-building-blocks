...
| File | What it shows |
|------|---------------|
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.8-cicd/01_github_actions.yml">01_github_actions.yml</a> | Basic CI workflow |
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.8-cicd/02_automated_tests.yml">02_automated_tests.yml</a> | Run tests with services |
| <a href="../../modules/Phase%204%20-%20Production%20Systems/4.8-cicd/03_deploy_workflow.yml">03_deploy_workflow.yml</a> | Deploy on merge to main |
...
- <a href="./4.1-docker.md">Docker</a> - What gets deployed
- <a href="./4.7-cloud-deployment.md">Cloud Deployment</a> - Where it deploys to
- <a href="../phase-3-advanced-patterns/3.8-evaluation-systems.md">Evaluation Systems</a> - Test AI systems in CI
