...
| File | What it shows |
|------|---------------|
| [01_github_actions.yml](../../modules/Phase 4 - Production Systems/4.8-cicd/01_github_actions.yml) | Basic CI workflow |
| [02_automated_tests.yml](../../modules/Phase 4 - Production Systems/4.8-cicd/02_automated_tests.yml) | Run tests with services |
| [03_deploy_workflow.yml](../../modules/Phase 4 - Production Systems/4.8-cicd/03_deploy_workflow.yml) | Deploy on merge to main |
