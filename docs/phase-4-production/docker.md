...
|--------|---------------|
| 01_dockerfile_basics.py | Creating Dockerfiles |
| 02_docker_compose.py | Multi-container orchestration |
| 03_environment_config.py | Managing configuration |
| Dockerfile | Production-ready example |
...
- [FastAPI Basics](../phase-3-advanced-patterns/fastapi-basics.md) - What goes in the container
- [PostgreSQL + pgvector](./postgresql-pgvector.md) - Database container
- [Cloud Deployment](./cloud-deployment.md) - Running containers in the cloud
