...
| 05_vector_search_pg.py | Semantic search |
| 06_hybrid_pg.py | Full-text + vector search |
...
- [Vector Search](../phase-1-foundations/vector-search.md) - ChromaDB basics
- [Docker](./docker.md) - Running PostgreSQL in containers
- [Advanced RAG](../phase-3-advanced-patterns/advanced-rag.md) - Hybrid search patterns
