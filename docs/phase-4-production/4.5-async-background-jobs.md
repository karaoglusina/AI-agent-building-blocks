...
|--------|---------------|
| [01_asyncio_basics.py](../../modules/Phase 4 - Production Systems/4.5-async-background-jobs/01_asyncio_basics.py) | Async/await fundamentals |
| [02_concurrent_llm.py](../../modules/Phase 4 - Production Systems/4.5-async-background-jobs/02_concurrent_llm.py) | Parallel LLM calls |
| [03_celery_setup.py](../../modules/Phase 4 - Production Systems/4.5-async-background-jobs/03_celery_setup.py) | Configure Celery with Redis |
| [04_background_task.py](../../modules/Phase 4 - Production Systems/4.5-async-background-jobs/04_background_task.py) | Long-running tasks |
| [05_task_status.py](../../modules/Phase 4 - Production Systems/4.5-async-background-jobs/05_task_status.py) | Monitor job progress |
