...
| File | What it shows |
|------|---------------|
| 01_github_actions.yml | Basic CI workflow |
| 02_automated_tests.yml | Run tests with services |
...
- [Docker](./docker.md) - What gets deployed
- [Cloud Deployment](./cloud-deployment.md) - Where it deploys to
- [Evaluation Systems](../phase-3-advanced-patterns/evaluation-systems.md) - Test AI systems in CI
