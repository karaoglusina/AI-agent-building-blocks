...
| File | What it shows |
|------|---------------|
| [01_vm_setup.md](../../modules/Phase 4 - Production Systems/4.7-cloud-deployment/01_vm_setup.md) | Setting up a cloud VM |
| [02_https_caddy.md](../../modules/Phase 4 - Production Systems/4.7-cloud-deployment/02_https_caddy.md) | HTTPS with Caddy |
| [03_health_checks.py](../../modules/Phase 4 - Production Systems/4.7-cloud-deployment/03_health_checks.py) | Health and readiness endpoints |
| [04_logging_config.py](../../modules/Phase 4 - Production Systems/4.7-cloud-deployment/04_logging_config.py) | Production logging |
