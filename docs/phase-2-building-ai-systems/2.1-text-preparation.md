...
|--------|---------------|
| [01_text_cleaning.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/01_text_cleaning.py) | Remove HTML, normalize whitespace, fix encoding |
| [02_tokenization_nltk.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/02_tokenization_nltk.py) | Word and sentence tokenization |
| [03_lemmatization_stemming.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/03_lemmatization_stemming.py) | Reduce words to base forms |
| [04_stopwords.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/04_stopwords.py) | Remove common words |
| [05_sentence_segmentation.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/05_sentence_segmentation.py) | Split text into sentences properly |
| [06_chunking_fixed.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/06_chunking_fixed.py) | Fixed-size chunks with overlap |
| [07_chunking_semantic.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/07_chunking_semantic.py) | Chunk by paragraphs and sections |
| [08_chunking_recursive.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/08_chunking_recursive.py) | Try multiple separators |
| [09_metadata_extraction.py](../../modules/Phase 2 - Building AI Systems/2.1-text-preparation/09_metadata_extraction.py) | Extract titles, dates, structure |
