...
|--------|---------------|
| [01_tool_calling_loop.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/01_tool_calling_loop.py) | Basic agent loop with tools |
| [02_sequential_chain.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/02_sequential_chain.py) | Chain multiple steps |
| [03_conditional_routing.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/03_conditional_routing.py) | Branch based on LLM decisions |
| [04_parallel_execution.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/04_parallel_execution.py) | Run tool calls concurrently |
| [05_tool_with_context.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/05_tool_with_context.py) | Pass context between tool calls |
| [06_error_recovery.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/06_error_recovery.py) | Handle tool failures |
| [07_agent_with_rag.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/07_agent_with_rag.py) | RAG as an agent tool |
| [08_multi_tool_agent.py](../../modules/Phase 2 - Building AI Systems/2.5-agent-orchestration/08_multi_tool_agent.py) | Agent with multiple capabilities |
