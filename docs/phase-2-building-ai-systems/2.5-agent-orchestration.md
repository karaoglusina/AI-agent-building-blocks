...
- [RAG Pipeline](./2.4-rag-pipeline.md) - Often used as an agent tool
- [Classification & Routing](./2.3-classification-routing.md) - Route queries before agent processing
- [Memory Patterns](./2.7-memory-patterns.md) - Agents with memory
- [Advanced Agent Patterns](../phase-3-advanced-patterns/3.1-advanced-agent-patterns.md) - ReAct, planning, reflection
