...
### [Text Preparation](./2.1-text-preparation.md)
...
### [Information Extraction](./2.2-information-extraction.md)
...
### [Classification & Routing](./2.3-classification-routing.md)
...
### [RAG Pipeline](./2.4-rag-pipeline.md)
...
### [Agent Orchestration](./2.5-agent-orchestration.md)
...
### [Context Engineering](./2.6-context-engineering.md)
...
### [Memory Patterns](./2.7-memory-patterns.md)
