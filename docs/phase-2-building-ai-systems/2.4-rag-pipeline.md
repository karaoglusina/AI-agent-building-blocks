...
|--------|---------------|
| [01_basic_rag.py](../../modules/Phase 2 - Building AI Systems/2.4-rag-pipeline/01_basic_rag.py) | End-to-end RAG pipeline |
| [02_context_assembly.py](../../modules/Phase 2 - Building AI Systems/2.4-rag-pipeline/02_context_assembly.py) | Formatting retrieved context |
| [03_source_citation.py](../../modules/Phase 2 - Building AI Systems/2.4-rag-pipeline/03_source_citation.py) | Including references in answers |
| [04_no_results_handling.py](../../modules/Phase 2 - Building AI Systems/2.4-rag-pipeline/04_no_results_handling.py) | Graceful fallbacks |
| [05_rag_with_filters.py](../../modules/Phase 2 - Building AI Systems/2.4-rag-pipeline/05_rag_with_filters.py) | Combining semantic search with filters |
| [06_rag_evaluation.py](../../modules/Phase 2 - Building AI Systems/2.4-rag-pipeline/06_rag_evaluation.py) | Measuring RAG quality |
