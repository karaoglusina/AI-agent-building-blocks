...
|--------|---------------|
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/01_conversation_buffer.py">01_conversation_buffer.py</a> | Simple full-history storage |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/02_sliding_window.py">02_sliding_window.py</a> | Bounded recent history |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/03_summary_memory.py">03_summary_memory.py</a> | Compress old messages |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/04_entity_memory.py">04_entity_memory.py</a> | Track entities in conversation |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/05_long_term_storage.py">05_long_term_storage.py</a> | Persist across sessions |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/06_memory_retrieval.py">06_memory_retrieval.py</a> | Semantic memory retrieval |
...
- <a href="../phase-1-foundations/1.4-conversations.md">Conversations</a> - Basic conversation handling
- <a href="./2.6-context-engineering.md">Context Engineering</a> - Memory as part of context
- <a href="./2.5-agent-orchestration.md">Agent Orchestration</a> - Agents with memory
- <a href="../phase-3-advanced-patterns/3.3-advanced-memory.md">Advanced Memory</a> - More sophisticated patterns
