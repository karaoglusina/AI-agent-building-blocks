...
|--------|---------------|
| [01_conversation_buffer.py](../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/01_conversation_buffer.py) | Simple full-history storage |
| [02_sliding_window.py](../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/02_sliding_window.py) | Bounded recent history |
| [03_summary_memory.py](../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/03_summary_memory.py) | Compress old messages |
| [04_entity_memory.py](../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/04_entity_memory.py) | Track entities in conversation |
| [05_long_term_storage.py](../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/05_long_term_storage.py) | Persist across sessions |
| [06_memory_retrieval.py](../../modules/Phase%202%20-%20Building%20AI%20Systems/2.7-memory-patterns/06_memory_retrieval.py) | Semantic memory retrieval |
