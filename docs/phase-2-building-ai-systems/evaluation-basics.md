...
| 02_retrieval_metrics.py | MRR, precision@k, recall@k |
| 03_generation_metrics.py | BLEU, ROUGE |
| 04_llm_as_judge.py | Using LLM for evaluation |
| 05_simple_eval_loop.py | Systematic evaluation pipeline |
| 06_comparison_eval.py | A/B comparison |
| 07_embedding_evaluation.py | Testing embeddings on your domain |
...
- [RAG Pipeline](./rag-pipeline.md) - Evaluating retrieval
- [Classification & Routing](./classification-routing.md) - Evaluating classification
- [Evaluation Systems](../phase-3-advanced-patterns/evaluation-systems.md) - Production evaluation
