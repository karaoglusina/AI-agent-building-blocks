...
|--------|---------------|
| [01_zero_shot.py](../../modules/Phase 2 - Building AI Systems/2.3-classification-routing/01_zero_shot.py) | LLM classification without training data |
| [02_few_shot.py](../../modules/Phase 2 - Building AI Systems/2.3-classification-routing/02_few_shot.py) | Classification with examples |
| [03_setfit_fewshot.py](../../modules/Phase 2 - Building AI Systems/2.3-classification-routing/03_setfit_fewshot.py) | Train a classifier with minimal data |
| [04_intent_detection.py](../../modules/Phase 2 - Building AI Systems/2.3-classification-routing/04_intent_detection.py) | Detect user intent from queries |
| [05_query_routing.py](../../modules/Phase 2 - Building AI Systems/2.3-classification-routing/05_query_routing.py) | Route queries to specialized handlers |
| [06_sentiment.py](../../modules/Phase 2 - Building AI Systems/2.3-classification-routing/06_sentiment.py) | Classify emotional tone |
