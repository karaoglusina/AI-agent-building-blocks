...
- [Agent Orchestration](./2.5-agent-orchestration.md) - Using classification in agent routing
- [Structured Output](../phase-1-foundations/1.3-structured-output.md) - Getting structured classification results
- [Evaluation Basics](./2.9-evaluation-basics.md) - Measuring classification accuracy
