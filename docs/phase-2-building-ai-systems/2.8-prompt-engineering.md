...
|--------|---------------|
| [01_system_prompt_design.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/01_system_prompt_design.py) | Structuring effective system prompts |
| [02_chain_of_thought.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/02_chain_of_thought.py) | Step-by-step reasoning |
| [03_few_shot_examples.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/03_few_shot_examples.py) | Learning from examples |
| [04_output_formatting.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/04_output_formatting.py) | Controlling output structure |
| [05_instructor_basics.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/05_instructor_basics.py) | Model-agnostic structured output |
| [06_constrained_generation.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/06_constrained_generation.py) | Forcing specific formats |
| [07_defensive_prompting.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/07_defensive_prompting.py) | Protecting against misuse |
| [08_self_consistency.py](../../modules/Phase 2 - Building AI Systems/2.8-prompt-engineering/08_self_consistency.py) | Multiple samples for reliability |
