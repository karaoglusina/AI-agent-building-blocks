...
- <a href="../phase-1-foundations/1.3-structured-output.md">Structured Output</a> - Schema-based formatting
- <a href="./2.3-classification-routing.md">Classification & Routing</a> - Prompts for classification
- <a href="./2.9-evaluation-basics.md">Evaluation Basics</a> - Measuring prompt quality
