...
|--------|---------------|
| [01_classification_metrics.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/01_classification_metrics.py) | Precision, recall, F1, confusion matrix |
| [02_retrieval_metrics.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/02_retrieval_metrics.py) | MRR, precision@k, recall@k |
| [03_generation_metrics.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/03_generation_metrics.py) | BLEU, ROUGE |
| [04_llm_as_judge.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/04_llm_as_judge.py) | Using LLM for evaluation |
| [05_simple_eval_loop.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/05_simple_eval_loop.py) | Systematic evaluation pipeline |
| [06_comparison_eval.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/06_comparison_eval.py) | A/B comparison |
| [07_embedding_evaluation.py](../../modules/Phase 2 - Building AI Systems/2.9-evaluation-basics/07_embedding_evaluation.py) | Testing embeddings on your domain |
