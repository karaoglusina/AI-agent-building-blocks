...
|--------|---------------|
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.6-context-engineering/01_context_window_basics.py">01_context_window_basics.py</a> | Understanding token limits |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.6-context-engineering/02_prompt_assembly.py">02_prompt_assembly.py</a> | Building prompts from components |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.6-context-engineering/03_context_prioritization.py">03_context_prioritization.py</a> | Selecting what to include |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.6-context-engineering/04_context_compression.py">04_context_compression.py</a> | Fitting more in less space |
| <a href="../../modules/Phase%202%20-%20Building%20AI%20Systems/2.6-context-engineering/05_dynamic_system_prompts.py">05_dynamic_system_prompts.py</a> | Adapting system prompts |
...
- <a href="./2.4-rag-pipeline.md">RAG Pipeline</a> - Managing retrieval context
- <a href="./2.7-memory-patterns.md">Memory Patterns</a> - Conversation history in context
- <a href="../phase-1-foundations/1.4-conversations.md">Conversations</a> - Basic conversation context
