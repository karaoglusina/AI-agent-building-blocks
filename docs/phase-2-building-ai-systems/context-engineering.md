...
|--------|---------------|
| 01_context_window_basics.py | Understanding token limits |
| 02_prompt_assembly.py | Building prompts from components |
| 03_context_prioritization.py | Selecting what to include |
| 04_context_compression.py | Fitting more in less space |
| 05_dynamic_system_prompts.py | Adapting system prompts |
...
- [RAG Pipeline](./rag-pipeline.md) - Managing retrieval context
- [Memory Patterns](./memory-patterns.md) - Conversation history in context
- [Conversations](../phase-1-foundations/conversations.md) - Basic conversation context
