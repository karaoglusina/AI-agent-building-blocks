...
|--------|---------------|
| 01_system_prompt_design.py | Structuring effective system prompts |
| 02_chain_of_thought.py | Step-by-step reasoning |
| 03_few_shot_examples.py | Learning from examples |
| 04_output_formatting.py | Controlling output structure |
| 05_instructor_basics.py | Model-agnostic structured output |
| 06_constrained_generation.py | Forcing specific formats |
| 07_defensive_prompting.py | Protecting against misuse |
| 08_self_consistency.py | Multiple samples for reliability |
...
- [Structured Output](../phase-1-foundations/structured-output.md) - Schema-based formatting
- [Classification & Routing](./classification-routing.md) - Prompts for classification
- [Evaluation Basics](./evaluation-basics.md) - Measuring prompt quality
