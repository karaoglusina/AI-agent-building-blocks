...
|--------|---------------|
| [01_ner_spacy.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/01_ner_spacy.py) | Standard NER with spaCy |
| [02_ner_custom.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/02_ner_custom.py) | Add custom entity patterns |
| [03_pos_tagging.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/03_pos_tagging.py) | Part-of-speech tagging |
| [04_grammar_noun_chunks.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/04_grammar_noun_chunks.py) | Extract noun phrases |
| [05_keywords_tfidf.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/05_keywords_tfidf.py) | TF-IDF keyword extraction |
| [06_keywords_keybert.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/06_keywords_keybert.py) | Embedding-based keywords |
| [07_lexicon_approaches.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/07_lexicon_approaches.py) | Dictionary-based extraction |
| [08_extraction_llm.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/08_extraction_llm.py) | LLM-based flexible extraction |
| [09_regex_patterns.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/09_regex_patterns.py) | Pattern matching with regex |
| [10_fuzzy_matching.py](../../modules/Phase 2 - Building AI Systems/2.2-information-extraction/10_fuzzy_matching.py) | Handling typos and variations |
