...
|--------|---------------|
| 01_conversation_buffer.py | Simple full-history storage |
| 02_sliding_window.py | Bounded recent history |
| 03_summary_memory.py | Compress old messages |
| 04_entity_memory.py | Track entities in conversation |
| 05_long_term_storage.py | Persist across sessions |
| 06_memory_retrieval.py | Semantic memory retrieval |
...
- [Conversations](../phase-1-foundations/conversations.md) - Basic conversation handling
- [Context Engineering](./context-engineering.md) - Memory as part of context
- [Agent Orchestration](./agent-orchestration.md) - Agents with memory
- [Advanced Memory](../phase-3-advanced-patterns/advanced-memory.md) - More sophisticated patterns
