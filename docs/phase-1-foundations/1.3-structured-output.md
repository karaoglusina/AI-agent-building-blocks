...
|--------|---------------|
| [01_json_mode.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/01_json_mode.py) | Force JSON output (older approach) |
| [02_structured_output.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/02_structured_output.py) | Pydantic schema for output |
| [03_extraction.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/03_extraction.py) | Extract structured data from text |
| [04_classification.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/04_classification.py) | Classify into predefined categories |
| [05_complex_extraction.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/05_complex_extraction.py) | Nested models for rich extraction |
| [06_batch_processing.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/06_batch_processing.py) | Process multiple items |
| [07_schema_inspection.py](../../modules/Phase%201%20-%20Foundations/1.3-structured-output/07_schema_inspection.py) | See the JSON schema Pydantic generates |
