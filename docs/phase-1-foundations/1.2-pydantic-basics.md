...
|--------|---------------|
| [01_basic_model.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/01_basic_model.py) | Define models with type hints |
| [02_field_types.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/02_field_types.py) | Common types: str, int, list, dict, datetime |
| [03_validation.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/03_validation.py) | Field constraints and custom validators |
| [04_nested_models.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/04_nested_models.py) | Models containing other models |
| [05_json_serialization.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/05_json_serialization.py) | Convert to/from JSON and dicts |
| [06_from_raw_data.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/06_from_raw_data.py) | Parse the job data into models |
| [07_model_methods.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/07_model_methods.py) | Add computed fields and methods |
| [08_enums_literals.py](../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/08_enums_literals.py) | Restrict values to specific options |
