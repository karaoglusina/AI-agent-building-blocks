...
|--------|---------------|
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/01_basic_model.py">01_basic_model.py</a> | Define models with type hints |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/02_field_types.py">02_field_types.py</a> | Common types: str, int, list, dict, datetime |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/03_validation.py">03_validation.py</a> | Field constraints and custom validators |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/04_nested_models.py">04_nested_models.py</a> | Models containing other models |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/05_json_serialization.py">05_json_serialization.py</a> | Convert to/from JSON and dicts |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/06_from_raw_data.py">06_from_raw_data.py</a> | Parse the job data into models |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/07_model_methods.py">07_model_methods.py</a> | Add computed fields and methods |
| <a href="../../modules/Phase%201%20-%20Foundations/1.2-pydantic-basics/08_enums_literals.py">08_enums_literals.py</a> | Restrict values to specific options |
...
- <a href="./1.3-structured-output.md">Structured Output</a> - Using Pydantic with OpenAI
- <a href="../phase-2-building-ai-systems/2.4-rag-pipeline.md">RAG Pipeline</a> - Structured data in retrieval
