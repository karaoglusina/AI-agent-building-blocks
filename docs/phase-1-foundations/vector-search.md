...
|--------|---------------|
| 01_chroma_basics.py | Basic add and query operations |
| 02_persistent_storage.py | Save collections to disk |
| 03_metadata_filtering.py | Filter results by metadata |
| 04_openai_embeddings.py | Use OpenAI embeddings with ChromaDB |
| 05_job_database.py | Build a searchable job database |
| 06_crud_operations.py | Create, Read, Update, Delete operations |
...
- [Embeddings](./embeddings.md) - Understanding what you're storing
- [RAG Pipeline](../phase-2-building-ai-systems/rag-pipeline.md) - Using vector search in retrieval
- [PostgreSQL + pgvector](../phase-4-production/postgresql-pgvector.md) - Production-grade vector storage
