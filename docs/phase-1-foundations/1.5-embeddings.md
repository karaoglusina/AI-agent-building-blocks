...
|--------|---------------|
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/01_basic_embedding.py">01_basic_embedding.py</a> | Create a single embedding |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/02_embedding_models.py">02_embedding_models.py</a> | Compare different embedding models |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/03_batch_embeddings.py">03_batch_embeddings.py</a> | Embed multiple texts efficiently |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/04_cosine_similarity.py">04_cosine_similarity.py</a> | Measure vector similarity |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/05_simple_search.py">05_simple_search.py</a> | Basic vector search implementation |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/06_job_search.py">06_job_search.py</a> | Search the job data by meaning |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/07_save_load_embeddings.py">07_save_load_embeddings.py</a> | Persist embeddings to disk |
| <a href="../../modules/Phase%201%20-%20Foundations/1.5-embeddings/08_numpy_operations.py">08_numpy_operations.py</a> | Essential numpy for vector operations |
...
- <a href="./1.6-vector-search.md">Vector Search</a> - Using a database for embeddings at scale
- <a href="../phase-2-building-ai-systems/2.4-rag-pipeline.md">RAG Pipeline</a> - Embeddings in retrieval-augmented generation
- <a href="../phase-2-building-ai-systems/2.1-text-preparation.md">Text Preparation</a> - Preparing text before embedding
