...
| 02_embedding_models.py | Compare different embedding models |
| 03_batch_embeddings.py | Embed multiple texts efficiently |
| 04_cosine_similarity.py | Measure vector similarity |
| 05_simple_search.py | Basic vector search implementation |
| 06_job_search.py | Search the job data by meaning |
| 07_save_load_embeddings.py | Persist embeddings to disk |
| 08_numpy_operations.py | Essential numpy for vector operations |
...
- [Vector Search](./vector-search.md) - Using a database for embeddings at scale
- [RAG Pipeline](../phase-2-building-ai-systems/rag-pipeline.md) - Embeddings in retrieval-augmented generation
- [Text Preparation](../phase-2-building-ai-systems/text-preparation.md) - Preparing text before embedding
