...
|--------|---------------|
| [01_chroma_basics.py](../../modules/Phase 1 - Foundations/1.6-vector-search/01_chroma_basics.py) | Basic add and query operations |
| [02_persistent_storage.py](../../modules/Phase 1 - Foundations/1.6-vector-search/02_persistent_storage.py) | Save collections to disk |
| [03_metadata_filtering.py](../../modules/Phase 1 - Foundations/1.6-vector-search/03_metadata_filtering.py) | Filter results by metadata |
| [04_openai_embeddings.py](../../modules/Phase 1 - Foundations/1.6-vector-search/04_openai_embeddings.py) | Use OpenAI embeddings with ChromaDB |
| [05_job_database.py](../../modules/Phase 1 - Foundations/1.6-vector-search/05_job_database.py) | Build a searchable job database |
| [06_crud_operations.py](../../modules/Phase 1 - Foundations/1.6-vector-search/06_crud_operations.py) | Create, Read, Update, Delete operations |
