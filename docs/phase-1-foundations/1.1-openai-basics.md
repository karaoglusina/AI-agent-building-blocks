...
|--------|---------------|
| [01_basic_call.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/01_basic_call.py) | Simplest possible API call |
| [02_input_formats.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/02_input_formats.py) | String vs message list input |
| [03_system_prompt.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/03_system_prompt.py) | Using system prompts to control behavior |
| [04_parameters.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/04_parameters.py) | Temperature, max_tokens, and other parameters |
| [05_response_object.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/05_response_object.py) | Understanding the response structure |
| [06_streaming.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/06_streaming.py) | Stream tokens as they arrive |
| [07_models.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/07_models.py) | Different models and when to use them |
| [08_error_handling.py](../../modules/Phase 1 - Foundations/1.1-openai-basics/08_error_handling.py) | Handling API errors gracefully |
