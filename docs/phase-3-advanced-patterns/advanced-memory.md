...
|--------|---------------|
| 01_structured_memory.py | Enforcing schemas on memories |
| 02_memory_importance.py | Scoring what to keep |
| 03_memory_consolidation.py | Merging redundant info |
| 04_preference_memory.py | Detecting and storing preferences |
| 05_episodic_memory.py | Recalling specific interactions |
...
- [Memory Patterns](../phase-2-building-ai-systems/memory-patterns.md) - Basic memory approaches
- [Multi-Agent Systems](./multi-agent-systems.md) - Shared memory across agents
- [Context Engineering](../phase-2-building-ai-systems/context-engineering.md) - Memory in context
