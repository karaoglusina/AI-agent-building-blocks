...
|--------|---------------|
| [01_structured_memory.py](../../modules/Phase 3 - Advanced Patterns/3.3-advanced-memory/01_structured_memory.py) | Enforcing schemas on memories |
| [02_memory_importance.py](../../modules/Phase 3 - Advanced Patterns/3.3-advanced-memory/02_memory_importance.py) | Scoring what to keep |
| [03_memory_consolidation.py](../../modules/Phase 3 - Advanced Patterns/3.3-advanced-memory/03_memory_consolidation.py) | Merging redundant info |
| [04_preference_memory.py](../../modules/Phase 3 - Advanced Patterns/3.3-advanced-memory/04_preference_memory.py) | Detecting and storing preferences |
| [05_episodic_memory.py](../../modules/Phase 3 - Advanced Patterns/3.3-advanced-memory/05_episodic_memory.py) | Recalling specific interactions |
