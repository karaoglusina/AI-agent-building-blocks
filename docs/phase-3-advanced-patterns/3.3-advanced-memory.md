...
|--------|---------------|
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.3-advanced-memory/01_structured_memory.py">01_structured_memory.py</a> | Enforcing schemas on memories |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.3-advanced-memory/02_memory_importance.py">02_memory_importance.py</a> | Scoring what to keep |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.3-advanced-memory/03_memory_consolidation.py">03_memory_consolidation.py</a> | Merging redundant info |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.3-advanced-memory/04_preference_memory.py">04_preference_memory.py</a> | Detecting and storing preferences |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.3-advanced-memory/05_episodic_memory.py">05_episodic_memory.py</a> | Recalling specific interactions |
...
- <a href="../phase-2-building-ai-systems/2.7-memory-patterns.md">Memory Patterns</a> - Basic memory approaches
- <a href="./3.2-multi-agent-systems.md">Multi-Agent Systems</a> - Shared memory across agents
- <a href="../phase-2-building-ai-systems/2.6-context-engineering.md">Context Engineering</a> - Memory in context
