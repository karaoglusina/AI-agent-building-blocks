...
|--------|---------------|
| [01_map_reduce.py](../../modules/Phase 3 - Advanced Patterns/3.5-iterative-processing/01_map_reduce.py) | Divide, process, combine |
| [02_progressive_summary.py](../../modules/Phase 3 - Advanced Patterns/3.5-iterative-processing/02_progressive_summary.py) | Multi-stage summarization |
| [03_refinement_chain.py](../../modules/Phase 3 - Advanced Patterns/3.5-iterative-processing/03_refinement_chain.py) | Iterative improvement |
| [04_hierarchical_processing.py](../../modules/Phase 3 - Advanced Patterns/3.5-iterative-processing/04_hierarchical_processing.py) | Detail to abstraction |
| [05_batch_processing.py](../../modules/Phase 3 - Advanced Patterns/3.5-iterative-processing/05_batch_processing.py) | High-throughput processing |
