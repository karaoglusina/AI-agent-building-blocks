...
|--------|---------------|
| 01_query_rewriting.py | Transform queries for better retrieval |
| 02_multi_hop_rag.py | Multiple retrieval steps |
| 03_self_rag.py | Decide when to retrieve |
| 04_cross_encoder_rerank.py | Two-stage retrieval |
| 05_hybrid_search.py | BM25 + semantic search |
| 06_rag_fusion.py | Multiple query perspectives |
...
- [RAG Pipeline](../phase-2-building-ai-systems/rag-pipeline.md) - Basic RAG patterns
- [Vector Search](../phase-1-foundations/vector-search.md) - Foundation for retrieval
- [Evaluation Systems](./evaluation-systems.md) - Measuring RAG quality
