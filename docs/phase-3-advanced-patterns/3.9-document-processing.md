...
|--------|---------------|
| [01_pdf_pymupdf.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.9-document-processing/01_pdf_pymupdf.py) | Fast, accurate extraction |
| [02_pdf_pypdf.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.9-document-processing/02_pdf_pypdf.py) | Pure Python extraction |
| [03_pdf_with_structure.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.9-document-processing/03_pdf_with_structure.py) | Preserve headings and hierarchy |
| [04_pdf_to_chunks.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.9-document-processing/04_pdf_to_chunks.py) | Full pipeline to indexed chunks |
...
- [Text Preparation](../phase-2-building-ai-systems/2.1-text-preparation.md) - Chunking strategies
- [RAG Pipeline](../phase-2-building-ai-systems/2.4-rag-pipeline.md) - Using processed documents
- [Vector Search](../phase-1-foundations/1.6-vector-search.md) - Indexing chunks
