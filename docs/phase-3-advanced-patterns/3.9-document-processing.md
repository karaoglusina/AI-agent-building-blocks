...
|--------|---------------|
| [01_pdf_pymupdf.py](../../modules/Phase 3 - Advanced Patterns/3.9-document-processing/01_pdf_pymupdf.py) | Fast, accurate extraction |
| [02_pdf_pypdf.py](../../modules/Phase 3 - Advanced Patterns/3.9-document-processing/02_pdf_pypdf.py) | Pure Python extraction |
| [03_pdf_with_structure.py](../../modules/Phase 3 - Advanced Patterns/3.9-document-processing/03_pdf_with_structure.py) | Preserve headings and hierarchy |
| [04_pdf_to_chunks.py](../../modules/Phase 3 - Advanced Patterns/3.9-document-processing/04_pdf_to_chunks.py) | Full pipeline to indexed chunks |
