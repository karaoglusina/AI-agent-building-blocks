...
|--------|---------------|
| 01_map_reduce.py | Divide, process, combine |
| 02_progressive_summary.py | Multi-stage summarization |
| 03_refinement_chain.py | Iterative improvement |
| 04_hierarchical_processing.py | Detail to abstraction |
| 05_batch_processing.py | High-throughput processing |
...
- [Context Engineering](../phase-2-building-ai-systems/context-engineering.md) - Managing what fits in context
- [Document Processing](./document-processing.md) - Preparing documents for processing
- [Evaluation Systems](./evaluation-systems.md) - Measuring processing quality
