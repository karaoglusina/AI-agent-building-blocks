...
|--------|---------------|
| 01_agent_handoff.py | Route to specialists based on intent |
| 02_specialized_agents.py | Agents with focused expertise |
| 03_coordinator_pattern.py | Orchestrator delegates to workers |
| 04_preference_detector.py | Extract and maintain preferences |
| 05_agent_communication.py | Inter-agent message passing |
...
- [Agent Orchestration](../phase-2-building-ai-systems/agent-orchestration.md) - Single agent basics
- [Advanced Agent Patterns](./advanced-agent-patterns.md) - Making individual agents smarter
- [Advanced Memory](./advanced-memory.md) - Shared memory across agents
