...
|--------|---------------|
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.4-advanced-rag/01_query_rewriting.py">01_query_rewriting.py</a> | Transform queries for better retrieval |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.4-advanced-rag/02_multi_hop_rag.py">02_multi_hop_rag.py</a> | Multiple retrieval steps |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.4-advanced-rag/03_self_rag.py">03_self_rag.py</a> | Decide when to retrieve |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.4-advanced-rag/04_cross_encoder_rerank.py">04_cross_encoder_rerank.py</a> | Two-stage retrieval |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.4-advanced-rag/05_hybrid_search.py">05_hybrid_search.py</a> | BM25 + semantic search |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.4-advanced-rag/06_rag_fusion.py">06_rag_fusion.py</a> | Multiple query perspectives |
...
- <a href="../phase-2-building-ai-systems/2.4-rag-pipeline.md">RAG Pipeline</a> - Basic RAG patterns
- <a href="../phase-1-foundations/1.6-vector-search.md">Vector Search</a> - Foundation for retrieval
- <a href="./3.8-evaluation-systems.md">Evaluation Systems</a> - Measuring RAG quality
