...
|--------|---------------|
| [01_query_rewriting.py](../../modules/Phase 3 - Advanced Patterns/3.4-advanced-rag/01_query_rewriting.py) | Transform queries for better retrieval |
| [02_multi_hop_rag.py](../../modules/Phase 3 - Advanced Patterns/3.4-advanced-rag/02_multi_hop_rag.py) | Multiple retrieval steps |
| [03_self_rag.py](../../modules/Phase 3 - Advanced Patterns/3.4-advanced-rag/03_self_rag.py) | Decide when to retrieve |
| [04_cross_encoder_rerank.py](../../modules/Phase 3 - Advanced Patterns/3.4-advanced-rag/04_cross_encoder_rerank.py) | Two-stage retrieval |
| [05_hybrid_search.py](../../modules/Phase 3 - Advanced Patterns/3.4-advanced-rag/05_hybrid_search.py) | BM25 + semantic search |
| [06_rag_fusion.py](../../modules/Phase 3 - Advanced Patterns/3.4-advanced-rag/06_rag_fusion.py) | Multiple query perspectives |
