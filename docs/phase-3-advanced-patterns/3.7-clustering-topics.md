...
|--------|---------------|
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.7-clustering-topics/01_kmeans_clustering.py">01_kmeans_clustering.py</a> | Basic document clustering |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.7-clustering-topics/02_umap_visualization.py">02_umap_visualization.py</a> | Visualize embeddings in 2D |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.7-clustering-topics/03_bertopic_basics.py">03_bertopic_basics.py</a> | Automatic topic discovery |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.7-clustering-topics/04_cluster_labeling.py">04_cluster_labeling.py</a> | Generate readable labels |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.7-clustering-topics/05_topic_coherence.py">05_topic_coherence.py</a> | Evaluate topic quality |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.7-clustering-topics/06_interactive_exploration.py">06_interactive_exploration.py</a> | Programmatic cluster exploration |
...
- <a href="../phase-1-foundations/1.5-embeddings.md">Embeddings</a> - Foundation for clustering
- <a href="../phase-2-building-ai-systems/2.2-information-extraction.md">Information Extraction</a> - Extract features for clustering
- <a href="./3.8-evaluation-systems.md">Evaluation Systems</a> - Measuring cluster quality
