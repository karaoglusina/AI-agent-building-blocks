...
|--------|---------------|
| [01_kmeans_clustering.py](../../modules/Phase 3 - Advanced Patterns/3.7-clustering-topics/01_kmeans_clustering.py) | Basic document clustering |
| [02_umap_visualization.py](../../modules/Phase 3 - Advanced Patterns/3.7-clustering-topics/02_umap_visualization.py) | Visualize embeddings in 2D |
| [03_bertopic_basics.py](../../modules/Phase 3 - Advanced Patterns/3.7-clustering-topics/03_bertopic_basics.py) | Automatic topic discovery |
| [04_cluster_labeling.py](../../modules/Phase 3 - Advanced Patterns/3.7-clustering-topics/04_cluster_labeling.py) | Generate readable labels |
| [05_topic_coherence.py](../../modules/Phase 3 - Advanced Patterns/3.7-clustering-topics/05_topic_coherence.py) | Evaluate topic quality |
| [06_interactive_exploration.py](../../modules/Phase 3 - Advanced Patterns/3.7-clustering-topics/06_interactive_exploration.py) | Programmatic cluster exploration |
