...
|--------|---------------|
| [01_eval_dataset.py](../../modules/Phase 3 - Advanced Patterns/3.8-evaluation-systems/01_eval_dataset.py) | Creating test data |
| [02_eval_pipeline.py](../../modules/Phase 3 - Advanced Patterns/3.8-evaluation-systems/02_eval_pipeline.py) | Automated evaluation |
| [03_regression_testing.py](../../modules/Phase 3 - Advanced Patterns/3.8-evaluation-systems/03_regression_testing.py) | Compare to baseline |
| [04_prompt_versioning.py](../../modules/Phase 3 - Advanced Patterns/3.8-evaluation-systems/04_prompt_versioning.py) | Track and compare prompts |
| [05_cost_tracking.py](../../modules/Phase 3 - Advanced Patterns/3.8-evaluation-systems/05_cost_tracking.py) | Monitor API costs |
| [06_human_eval_design.py](../../modules/Phase 3 - Advanced Patterns/3.8-evaluation-systems/06_human_eval_design.py) | Structure human evaluation |
