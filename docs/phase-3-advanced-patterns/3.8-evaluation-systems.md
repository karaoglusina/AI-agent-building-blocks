...
- <a href="../phase-2-building-ai-systems/2.9-evaluation-basics.md">Evaluation Basics</a> - Individual metrics
- <a href="../phase-2-building-ai-systems/2.4-rag-pipeline.md">RAG Pipeline</a> - RAG evaluation
- <a href="../phase-4-production/4.3-observability.md">Observability</a> - Production monitoring
