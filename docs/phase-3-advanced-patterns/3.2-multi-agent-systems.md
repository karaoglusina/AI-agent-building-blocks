...
|--------|---------------|
| [01_agent_handoff.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/01_agent_handoff.py) | Route to specialists based on intent |
| [02_specialized_agents.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/02_specialized_agents.py) | Agents with focused expertise |
| [03_coordinator_pattern.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/03_coordinator_pattern.py) | Orchestrator delegates to workers |
| [04_preference_detector.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/04_preference_detector.py) | Extract and maintain preferences |
| [05_agent_communication.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/05_agent_communication.py) | Inter-agent message passing |
