...
|--------|---------------|
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/01_agent_handoff.py">01_agent_handoff.py</a> | Route to specialists based on intent |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/02_specialized_agents.py">02_specialized_agents.py</a> | Agents with focused expertise |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/03_coordinator_pattern.py">03_coordinator_pattern.py</a> | Orchestrator delegates to workers |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/04_preference_detector.py">04_preference_detector.py</a> | Extract and maintain preferences |
| <a href="../../modules/Phase%203%20-%20Advanced%20Patterns/3.2-multi-agent-systems/05_agent_communication.py">05_agent_communication.py</a> | Inter-agent message passing |
...
- <a href="../phase-2-building-ai-systems/2.5-agent-orchestration.md">Agent Orchestration</a> - Single agent basics
- <a href="./3.1-advanced-agent-patterns.md">Advanced Agent Patterns</a> - Making individual agents smarter
- <a href="./3.3-advanced-memory.md">Advanced Memory</a> - Shared memory across agents
