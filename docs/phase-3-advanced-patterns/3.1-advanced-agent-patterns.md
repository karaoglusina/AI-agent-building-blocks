...
|--------|---------------|
| [01_react_pattern.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/01_react_pattern.py) | Reason-Act-Observe loop |
| [02_reflection.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/02_reflection.py) | Self-critique and improvement |
| [03_planning.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/03_planning.py) | Decompose then execute |
| [04_self_correction.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/04_self_correction.py) | Automatic error recovery |
| [05_confidence_routing.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/05_confidence_routing.py) | Route by model confidence |
| [06_iterative_refinement.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/06_iterative_refinement.py) | Multi-pass improvement |
| [07_tree_of_thought.py](../../modules/Phase%203%20-%20Advanced%20Patterns/3.1-advanced-agent-patterns/07_tree_of_thought.py) | Explore multiple paths |
