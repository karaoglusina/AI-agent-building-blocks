...
- <a href="../phase-2-building-ai-systems/2.5-agent-orchestration.md">Agent Orchestration</a> - Basic agent patterns
- <a href="./3.2-multi-agent-systems.md">Multi-Agent Systems</a> - Coordinating multiple agents
- <a href="./3.8-evaluation-systems.md">Evaluation Systems</a> - Measuring agent quality
