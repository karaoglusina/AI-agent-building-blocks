...
|--------|---------------|
| 01_pdf_pymupdf.py | Fast, accurate extraction |
| 02_pdf_pypdf.py | Pure Python extraction |
| 03_pdf_with_structure.py | Preserve headings and hierarchy |
| 04_pdf_to_chunks.py | Full pipeline to indexed chunks |
...
- [Text Preparation](../phase-2-building-ai-systems/text-preparation.md) - Chunking strategies
- [RAG Pipeline](../phase-2-building-ai-systems/rag-pipeline.md) - Using processed documents
- [Vector Search](../phase-1-foundations/vector-search.md) - Indexing chunks
