...
|--------|---------------|
| 01_vision_basics.py | Analyze images with GPT-4V |
| 02_clip_basics.py | Text-image similarity with CLIP |
| 03_image_text_search.py | Build CLIP-based search |
| 04_document_vision.py | Extract structured data from documents |
...
- [Document Processing](../phase-3-advanced-patterns/document-processing.md) - PDF handling
- [Custom Embeddings](./custom-embeddings.md) - Combine with CLIP embeddings
- [Advanced RAG](../phase-3-advanced-patterns/advanced-rag.md) - Multimodal RAG
- [Cloud Deployment](../phase-4-production/cloud-deployment.md) - Deploy vision systems
