...
|--------|---------------|
| [01_sentence_transformers.py](../../modules/Phase 5 - Custom Models and Multimodal/5.2-custom-embeddings/01_sentence_transformers.py) | Local embeddings with Sentence Transformers |
| [02_domain_adaptation_tsdae.py](../../modules/Phase 5 - Custom Models and Multimodal/5.2-custom-embeddings/02_domain_adaptation_tsdae.py) | Unsupervised adaptation for your domain |
| [03_embedding_evaluation.py](../../modules/Phase 5 - Custom Models and Multimodal/5.2-custom-embeddings/03_embedding_evaluation.py) | Measure embedding quality rigorously |
| [04_bias_in_embeddings.py](../../modules/Phase 5 - Custom Models and Multimodal/5.2-custom-embeddings/04_bias_in_embeddings.py) | Detect and mitigate embedding biases |
