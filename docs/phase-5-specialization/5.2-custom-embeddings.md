...
|--------|---------------|
| [01_sentence_transformers.py](../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.2-custom-embeddings/01_sentence_transformers.py) | Local embeddings with Sentence Transformers |
| [02_domain_adaptation_tsdae.py](../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.2-custom-embeddings/02_domain_adaptation_tsdae.py) | Unsupervised adaptation for your domain |
| [03_embedding_evaluation.py](../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.2-custom-embeddings/03_embedding_evaluation.py) | Measure embedding quality rigorously |
| [04_bias_in_embeddings.py](../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.2-custom-embeddings/04_bias_in_embeddings.py) | Detect and mitigate embedding biases |
...
- [Embeddings](../phase-1-foundations/1.5-embeddings.md) - The basics
- [Vector Search](../phase-1-foundations/1.6-vector-search.md) - Using embeddings for search
- [Advanced RAG](../phase-3-advanced-patterns/3.4-advanced-rag.md) - Embeddings in RAG systems
- [Fine-tuning](./5.1-fine-tuning.md) - When to fine-tune models instead
