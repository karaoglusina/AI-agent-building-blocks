...
|--------|----------------|
| [Fine-tuning](./fine-tuning.md) | When and how to train custom models |
| [Custom Embeddings](./custom-embeddings.md) | Local embeddings and domain adaptation |
| [Advanced NLP](./advanced-nlp.md) | Structured extraction with traditional techniques |
| [Multimodal](./multimodal.md) | Working with images and text together |
