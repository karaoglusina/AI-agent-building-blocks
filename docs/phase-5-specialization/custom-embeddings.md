...
|--------|---------------|
| 01_sentence_transformers.py | Local embeddings with Sentence Transformers |
| 02_domain_adaptation_tsdae.py | Unsupervised adaptation for your domain |
| 03_embedding_evaluation.py | Measure embedding quality rigorously |
| 04_bias_in_embeddings.py | Detect and mitigate embedding biases |
...
- [Embeddings](../phase-1-foundations/embeddings.md) - The basics
- [Vector Search](../phase-1-foundations/vector-search.md) - Using embeddings for search
- [Advanced RAG](../phase-3-advanced-patterns/advanced-rag.md) - Embeddings in RAG systems
- [Fine-tuning](./fine-tuning.md) - When to fine-tune models instead
