...
|--------|---------------|
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.1-fine-tuning/01_when_to_finetune.py">01_when_to_finetune.py</a> | Decision framework for when to fine-tune |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.1-fine-tuning/02_data_preparation.py">02_data_preparation.py</a> | Format and validate training data |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.1-fine-tuning/03_lora_basics.py">03_lora_basics.py</a> | Parameter-efficient fine-tuning |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.1-fine-tuning/04_quantization.py">04_quantization.py</a> | Run models with reduced precision |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.1-fine-tuning/05_sft_rlhf_dpo_overview.py">05_sft_rlhf_dpo_overview.py</a> | Alignment techniques explained |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.1-fine-tuning/06_evaluation.py">06_evaluation.py</a> | Measure if fine-tuning helped |
...
- <a href="../phase-2-building-ai-systems/2.8-prompt-engineering.md">Prompt Engineering</a> - Try this first
- <a href="../phase-2-building-ai-systems/2.4-rag-pipeline.md">RAG Pipeline</a> - Often better than fine-tuning for knowledge
- <a href="./5.2-custom-embeddings.md">Custom Embeddings</a> - Fine-tune embeddings for retrieval
- <a href="../phase-3-advanced-patterns/3.8-evaluation-systems.md">Evaluation Systems</a> - Measure improvements
