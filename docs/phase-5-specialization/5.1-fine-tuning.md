...
|--------|---------------|
| [01_when_to_finetune.py](../../modules/Phase 5 - Custom Models and Multimodal/5.1-fine-tuning/01_when_to_finetune.py) | Decision framework for when to fine-tune |
| [02_data_preparation.py](../../modules/Phase 5 - Custom Models and Multimodal/5.1-fine-tuning/02_data_preparation.py) | Format and validate training data |
| [03_lora_basics.py](../../modules/Phase 5 - Custom Models and Multimodal/5.1-fine-tuning/03_lora_basics.py) | Parameter-efficient fine-tuning |
| [04_quantization.py](../../modules/Phase 5 - Custom Models and Multimodal/5.1-fine-tuning/04_quantization.py) | Run models with reduced precision |
| [05_sft_rlhf_dpo_overview.py](../../modules/Phase 5 - Custom Models and Multimodal/5.1-fine-tuning/05_sft_rlhf_dpo_overview.py) | Alignment techniques explained |
| [06_evaluation.py](../../modules/Phase 5 - Custom Models and Multimodal/5.1-fine-tuning/06_evaluation.py) | Measure if fine-tuning helped |
