...
|--------|---------------|
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.4-multimodal/01_vision_basics.py">01_vision_basics.py</a> | Analyze images with GPT-4V |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.4-multimodal/02_clip_basics.py">02_clip_basics.py</a> | Text-image similarity with CLIP |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.4-multimodal/03_image_text_search.py">03_image_text_search.py</a> | Build CLIP-based search |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.4-multimodal/04_document_vision.py">04_document_vision.py</a> | Extract structured data from documents |
...
- <a href="../phase-3-advanced-patterns/3.9-document-processing.md">Document Processing</a> - PDF handling
- <a href="./5.2-custom-embeddings.md">Custom Embeddings</a> - Combine with CLIP embeddings
- <a href="../phase-3-advanced-patterns/3.4-advanced-rag.md">Advanced RAG</a> - Multimodal RAG
- <a href="../phase-4-production/4.7-cloud-deployment.md">Cloud Deployment</a> - Deploy vision systems
