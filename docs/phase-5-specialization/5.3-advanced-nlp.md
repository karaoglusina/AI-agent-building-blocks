...
|--------|---------------|
| [01_dependency_parsing.py](../../modules/Phase 5 - Custom Models and Multimodal/5.3-advanced-nlp/01_dependency_parsing.py) | Extract grammatical structure |
| [02_relation_extraction.py](../../modules/Phase 5 - Custom Models and Multimodal/5.3-advanced-nlp/02_relation_extraction.py) | Find relationships between entities |
| [03_coreference.py](../../modules/Phase 5 - Custom Models and Multimodal/5.3-advanced-nlp/03_coreference.py) | Resolve pronouns to antecedents |
