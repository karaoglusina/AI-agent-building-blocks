...
|--------|---------------|
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.3-advanced-nlp/01_dependency_parsing.py">01_dependency_parsing.py</a> | Extract grammatical structure |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.3-advanced-nlp/02_relation_extraction.py">02_relation_extraction.py</a> | Find relationships between entities |
| <a href="../../modules/Phase%205%20-%20Custom%20Models%20and%20Multimodal/5.3-advanced-nlp/03_coreference.py">03_coreference.py</a> | Resolve pronouns to antecedents |
...
- <a href="../phase-2-building-ai-systems/2.2-information-extraction.md">Information Extraction</a> - Broader extraction techniques
- <a href="../phase-2-building-ai-systems/2.1-text-preparation.md">Text Preparation</a> - Preparing text for NLP
- <a href="./5.1-fine-tuning.md">Fine-tuning</a> - Train custom models for NLP tasks
- <a href="../phase-2-building-ai-systems/2.3-classification-routing.md">Classification and Routing</a> - Related classification approaches
