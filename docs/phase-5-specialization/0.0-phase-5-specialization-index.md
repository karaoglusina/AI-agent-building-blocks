...
|--------|----------------|
| <a href="./5.1-fine-tuning.md">Fine-tuning</a> | When and how to train custom models |
| <a href="./5.2-custom-embeddings.md">Custom Embeddings</a> | Local embeddings and domain adaptation |
| <a href="./5.3-advanced-nlp.md">Advanced NLP</a> | Structured extraction with traditional techniques |
| <a href="./5.4-multimodal.md">Multimodal</a> | Working with images and text together |
